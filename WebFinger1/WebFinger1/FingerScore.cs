...
namespace WebFinger1
{
	public class FingerScore
	{
		...
		string ImagePathProbe = Path.Combine("/Applications/XAMPP/xamppfiles/htdocs/fingerprint3/assets/images/temporary/");
		string ImagePathPersonFinger = Path.Combine("/Applications/XAMPP/xamppfiles/htdocs/fingerprint3/assets/images/form/");
