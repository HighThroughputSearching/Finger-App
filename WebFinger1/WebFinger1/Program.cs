...
public class Program
{
	...
	// Initialize path to images
		//public  string xmlPath = Path.Combine(Path.Combine("..", ".."), "xml");
	//public  string ImagePath = Path.Combine ("/Applications/XAMPP/xamppfiles/htdocs/fingerprint3/assets/images/form/", "right_thumb/");
	public  string xmlPath = Path.Combine ("/Users/prisadumrongsiri/Projects/WebFinger1 copy/WebFinger1/", "xml");
